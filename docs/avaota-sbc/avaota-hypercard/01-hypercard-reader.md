...
![image-20240706143554986](assets/post/hypercard-reader/image-20240706143554986.png)
...
![image-20240706003831902](assets/post/hypercard-reader/image-20240706003831902.png)

点击 `Prog` 按钮

![image-20240706003907396](assets/post/hypercard-reader/image-20240706003907396.png)

此时 Avaota Debugger 灯闪。将 Avaota Debugger 的背面朝上，使用连接线插入正面朝上的 Avaota Hyper Card Reader，方向如图所示：

![image-20240705205837998](assets/post/hypercard-reader/image-20240705205837998.png)

看到 `Complete !` 即刷写完成。



![image-20240706003957855](assets/post/hypercard-reader/image-20240706003957855.png)
...
![image-20240705205509348](assets/post/hypercard-reader/image-20240705205509348.png)

然后设置速率，最小 1200，最大 2400

![image-20240705205559758](assets/post/hypercard-reader/image-20240705205559758.png)

点击 Open Code File，打开 `hex` 文件

![image-20240705205639366](assets/post/hypercard-reader/image-20240705205639366.png)

点击 `Download/Program` 进入下载模式

![image-20240705205706318](assets/post/hypercard-reader/image-20240705205706318.png)

此时会显示 `Checking target MCU ... `

![image-20240705205716843](assets/post/hypercard-reader/image-20240705205716843.png)
...
![image-20240705205937023](assets/post/hypercard-reader/image-20240705205937023.png)

下载完毕

![image-20240705205952426](assets/post/hypercard-reader/image-20240705205952426.png)
